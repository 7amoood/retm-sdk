...
abstract class Queue
{
    ...
    {
        $listener = property_exists($job, 'class') ? $this->container->make($job->class) : $job;
        $payload = $this->withCreatePayloadHooks($queue, [
            ...
            'service'   => $listener->service ?? (method_exists($listener, 'queuedClient') && $listener->queuedClient() ? $listener->getService() : null),
            'business' => $listener->business ?? (method_exists($listener, 'queuedClient') && $listener->queuedClient() ? $listener->getBusiness() : null),
            'data' => [
                'commandName' => $job,
                'command' => $job,
            ],
